                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="product-thumbnail">
                                                <a href="{{URL::to('/product-details/'.$v_content->id)}}"><img src="{{URL::to('public/upload/product/'.$v_content->options->image)}}" width="125" alt=""></a>
                                            </td>
                                            <td class="product-name"><a href="{{URL::to('/product-details/'.$v_content->id)}}">{{$v_content->name}} </a></td>
                                            <td class="product-price-cart"><span class="amount">{{number_format($v_content->price).'$'}}</span></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="grand-totall">
                                    ...
                                    <h4 class="grand-totall-title">Grand Total  <span>{{Cart::subtotal().'$'}}</span></h4>
