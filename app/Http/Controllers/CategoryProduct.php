...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home(Request $request,$category_id){
        ...
        foreach($category_by_id as $key => $val){
            ...
            $meta_title = "$val->category_name | Korean Beauty Products, Skincare & Makeup | innisfree";
        ...
        return view('pages.category.show_category')->with('category',$cate_product)->with('origin',$origin_product)->with('category_by_id',$category_by_id)->with('category_name',$category_name)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical);
    }
